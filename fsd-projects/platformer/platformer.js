$(function () {
  ...
  function setup() {
   ...
   // toggleGrid();
    ...
    createPlatform(300, 480, 600, 30, "blue");
    createPlatform(400, 700, 400, 20, "green");
    createPlatform(1000, 610, 400, 20, "orange");
    createPlatform(1150, 400, 300, 40, "purple")
    ...
    createCannon("right", 700, 1900);
    createCannon("top", 1000, 1900);
    //////////////////////////////////
